...
<div id="topicTabContent" >
   	...
   	<div class="panel panel-default">
          ...
          <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo e(route('spiderJob.post')); ?>" role="form" data-toggle="validator">

            <div class="form-group">
	          <label class="col-sm-2 control-label" >标题</label>
	          <div class="col-sm-10">
	            <input type="text" name="title" value="<?php echo e(isset($spiderJob->title)?$spiderJob->title:''); ?>" class="form-control">
	          </div>
	        </div>
            ...
            <div class="line line-dashed b-b line-lg pull-in"></div>
                  ...
                  <div class="col-sm-10">
                      ...
                      <div class="radio ">
                        <label class="i-checks">
                          ...
                          <?php if(isset($spiderJob)): ?>
                          <input type="radio"  name="category_id" value="<?php echo e($category->id); ?>" <?php if($category->id == $spiderJob->category_id): ?> checked <?php endif; ?> name="category_id">
                          <?php echo e($spiderJob->category_id); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <textarea id="summernote" name="content" value="" class="form-control" rows="3" placeholder="页面描述 ..."><?php echo e(isset($spiderJob->content)?$spiderJob->content:''); ?></textarea>
               ...
               <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
            	 <input type="hidden" name="id" value="<?php echo e($spiderJob->id); ?>">
