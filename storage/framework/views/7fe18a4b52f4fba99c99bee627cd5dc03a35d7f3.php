      ...
      <div class="collapse pos-rlt navbar-collapse box-shadow bg-white-only">
        ...
        <ul class="nav navbar-nav ">
            <?php $__currentLoopData = App\Category::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <li class="<?php if(app('request')->input('game') == $cat->url_name): ?> active <?php endif; ?>">
              <a href="<?php echo e(url($cat->url_name)); ?>" target="_blank">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown">
            <a href="#" data-toggle="dropdown" class="dropdown-toggle clear" data-toggle="dropdown">
              ...
              <span class="hidden-sm hidden-md"><?php echo e(Auth::guard('admin')->user()->name); ?></span> <b class="caret"></b>
            </a>
            <!-- dropdown -->
