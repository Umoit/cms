...
<div class="bg-light lter b-b wrapper-md">
      ...
      <div class="row">
        <div class="col-sm-6 col-xs-12">
          ...
          <a class="btn btn-success" href="<?php echo e(route('article.create')); ?>">添加文章</a>
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
           ...
           <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <tr>
                      <td class="dbid"><?php echo e($article->id); ?></td>
                      <td><?php echo e($article->title); ?></td>
                      <td><?php echo e($article->category->name); ?></td>
                      <td><?php echo e($article->created_at); ?></td>
                      <td>
                        <a target="_blank" href="<?php echo e(route('articleShow',$article->id)); ?>"><button type="button" class="btn btn-success btn-xs">查看</button></a>
                        <a href="<?php echo e(route('article.edit',$article->id)); ?>"><button type="button" class="btn btn-info btn-xs">编辑</button></a>
                        <a onclick="showDeleteModal(this)"  data="<?php echo e(route('article.delete',$article->id)); ?>"><button type="button" class="btn btn-danger btn-xs">删除</button></a>
    ...
    <footer class="panel-footer">
      <div class="row">
        ...
        <div class="col-sm-3 text-center">
          <small class="text-muted inline m-t-sm m-b-sm">showing <?php echo e($articles->firstItem()); ?>-<?php echo e($articles->lastItem()); ?> of <?php echo e($articles->total()); ?> items</small>
        </div>
