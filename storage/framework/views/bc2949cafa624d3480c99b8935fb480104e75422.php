          ...
          <?php $__currentLoopData = App\Article::getArticleByCat(1,2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           ...
           <li class="posts__item ">
            <div class="posts__thumb posts__thumb--hover">
             <a href="#"><img width="96px;" src="<?php echo e($article1->img); ?>" alt="" /></a>
             </div>
            <div class="posts__inner">
             <div class="posts__cat">
              <span class="label posts__cat-label posts__cat-label--category-4">aaosd</span>
             </div>
             <h6 class="posts__title posts__title--color-hover"><a href="_esports_blog-post-1.html"><?php echo e($article1->title); ?></a></h6>
             <time datetime="2017-08-21" class="posts__date"><?php echo e($article1->created_at); ?></time>
            </div>
            </li>
