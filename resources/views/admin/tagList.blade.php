      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
           ...
           @foreach ($tags as $data)
              ...
              <td>
                <a target="_blank" href="{{route('tag.show',$data->id)}}"><button type="button" class="btn btn-success btn-xs">查看</button></a>
                <a href="{{route('tag.edit',$data->id)}}"><button type="button" class="btn btn-info btn-xs">编辑</button></a>
                
                 <a onclick="showDeleteModal(this)"  data="{{route('tag.delete',$data->id)}}"><button type="button" class="btn btn-danger btn-xs">删除</button></a>
              </td>
            </tr>
            @endforeach
    ...
    <footer class="panel-footer">
      <div class="row">
        ...
        <div class="col-sm-6 text-center">
          <small class="text-muted inline m-t-sm m-b-sm">showing {{$tags->firstItem()}}-{{$tags->lastItem()}} of {{$tags->total()}} items</small>
        </div>
