    ...
    <div class="table-responsive">
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
                    ...
                    @foreach ($spiderJobs as $data)

                      <tr>
                      <td class="dbid">{{$data->id}}</td>
                      <td>{{$data->title}}</td>
                      ...
                      <td>
                        ...
                        <a href="{{route('jobToArticle',$data->id)}}"><button type="button" class="btn btn-info btn-xs">发布文章</button></a>
                        <a onclick="showDeleteModal(this)"  data="{{route('spiderJob.delete',$data->id)}}"><button type="button" class="btn btn-danger btn-xs">删除</button></a>
    ...
    <footer class="panel-footer">
      <div class="row">
        ...
        <div class="col-sm-3 text-center">
          <small class="text-muted inline m-t-sm m-b-sm">showing {{$spiderJobs->firstItem()}}-{{$spiderJobs->lastItem()}} of {{$spiderJobs->total()}} items</small>
        </div>
