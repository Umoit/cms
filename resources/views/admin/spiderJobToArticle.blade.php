...
<div id="topicTabContent" >
   	...
   	<div class="panel panel-default">
          ...
          <form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{route('spiderJob.post')}}" role="form" data-toggle="validator">

            <div class="form-group">
	          <label class="col-sm-2 control-label" >标题</label>
	          <div class="col-sm-10">
	            <input type="text" name="title" value="{{isset($spiderJob->title)?$spiderJob->title:''}}" class="form-control">
	          </div>
	        </div>
	        ...
	        <div class="form-group">
                  <label name="img" class="col-sm-2 control-label">缩略图</label>
                     ...
                     <div ><img id="image_preview" style="padding-bottom:10px;" width="100%" src=" @if (isset($spiderJob->img)) {{$spiderJob->img}} @endif"></div> 
                    

                    	<input type="file"  class="file" id="img_url" name="image_data"  accept="image/*" multiple>
                   		<input type="hidden"  id="image" name="img"  value="@if (isset($spiderJob->img)) {{$spiderJob->img}} @endif">
          			</div>
          	</div>
            ...
            <div class="line line-dashed b-b line-lg pull-in"></div>
                  ...
                  <div class="col-sm-10">
                      ...
                      <div class="radio ">
                        <label class="i-checks">
                          ...
                          @if(isset($spiderJob))
                          <input type="radio"  name="category_id" value="{{$category->id}}" @if($category->id == $spiderJob->category_id) checked @endif name="category_id">
                          {{$spiderJob->category_id}}
                          @else
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <textarea id="summernote" name="content" value="" class="form-control" rows="3" placeholder="页面描述 ...">{{isset($spiderJob->content)?$spiderJob->content:''}}</textarea>
               ...
               <input type="hidden" name="_token" value="{{ csrf_token() }}">
            	 <input type="hidden" name="id" value="{{$spiderJob->id}}">
