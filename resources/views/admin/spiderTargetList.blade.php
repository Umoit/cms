    ...
    <div class="row">
      <div class="col-xs-12 col-md-4">
        ...
        <div class="panel-body">
          <form class="form-horizontal"  action="{{route('spiderTarget.store')}}" method="post" role="form">
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
           ...
           @foreach ($spiderTargets as $data)
              ...
              <td>
              <a href="{{route('createSpiderJob',$data->id)}}"><button type="button" class="btn btn-success btn-xs">生成任务</button></a>
                <a href="{{route('spiderTarget.edit',$data->id)}}"><button type="button" class="btn btn-info btn-xs">编辑</button></a>
                
                 <a onclick="showDeleteModal(this)"  data="{{route('spiderTarget.delete',$data->id)}}"><button type="button" class="btn btn-danger btn-xs">删除</button></a>
              </td>
            </tr>
            @endforeach
    ...
    <footer class="panel-footer">
      <div class="row">
        ...
        <div class="col-sm-6 text-center">
          <small class="text-muted inline m-t-sm m-b-sm">showing {{$spiderTargets->firstItem()}}-{{$spiderTargets->lastItem()}} of {{$spiderTargets->total()}} items</small>
        </div>
